                        ...
                        new ContainerBuilder()
                            .addSectionComponents(
                                new SectionBuilder()
                                    ...
                                    .addTextDisplayComponents(
                                        new TextDisplayBuilder().setContent(`<a:loading:1457777985431015618> You do not own this package! This is either because you have not bought it yet, which you can do by [**clicking here**](${data.purchaselink}) or because your Roblox inventory visibility is set to private.`),
                                    ),
                            ),
                ];
                await interaction.editReply({
